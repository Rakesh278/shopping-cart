...
resource "aws_iam_policy" "ec2_policy" {
  ...
  description = "Allow EC2 to access ECR and CloudWatch"
  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      },
      {
        ...
        Resource = "arn:aws:dynamodb:us-west-2:825094176106:table/terraform-locks"
      }
    ]
  })
}
...
resource "aws_iam_user_policy_attachment" "terraform_user_attach" {
  user       = "Rakesh" # Replace with your actual IAM username
  policy_arn = aws_iam_policy.terraform_backend_policy.arn
}
